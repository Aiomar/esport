...
export default function Footer() {
  return (
    <footer
      id="Contact"
      className="flex sm:flex-col md:flex-row items-center w-full h-80 md:h-auto bg-gray-950 md:pt-1 p-10 md:p-0"
    >
      <div className="flex flex-col md:flex-row md:float-start mt-2 md:ml-10 w-60 h-64">
        <div className="flex flex-col">
          ...
          <span className="text-gray-300 mt-2 flex flex-row items-center">
          ...
          <span className="text-gray-300 mt-2 flex flex-row items-center w-96 font-mono text-sm ">
